...
import type { WorkflowResponseDto, WorkflowExecutionSummaryDto } from '../dto/workflow-response.dto';
    ...
    async create(
        ...
        const workflow = await this.prisma.workflow.create({
            data: {
                ...
                definition: (definition ?? { nodes: nodes ?? [], edges: edges ?? [] }) as object,
    ...
    async update(
        ...
        const updated = await this.prisma.workflow.update({
            ...
            data: {
                ...
                ...(definition !== undefined || nodes !== undefined || edges !== undefined
                    ? {
                        definition: ({
