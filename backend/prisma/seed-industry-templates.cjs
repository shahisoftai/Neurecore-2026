 ...
 *
 * Run: node prisma/seed-industry-templates.cjs
 *
 * Flags:
...
const TEMPLATES = [
  ...
  },
  {
    ...
    config: {
      ...
      defaultStage: 'lead',
      customerFieldDefinitions: [
        { key: 'policyType', label: 'Policy Type', type: 'enum', options: ['Life', 'Health', 'Property', 'Auto', 'Liability'] },
        { key: 'riskTier', label: 'Risk Tier', type: 'enum', options: ['Preferred', 'Standard', 'Substandard'] },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    industrySlug: 'accounting-audit-services',
    config: {
      metrics: ['auditsCompleted', 'findingsIdentified', 'findingsResolved', 'averageCompletionDays'],
      period: 'quarterly',
      format: 'dashboard',
    },
  },
  {
    ...
    industrySlug: 'insurance',
    config: {
      metrics: ['claimsFiled', 'claimsApproved', 'claimsDenied', 'averageProcessingDays', 'totalPayoutAmount'],
      period: 'monthly',
      format: 'dashboard',
    },
  },
  ...
  },
  {
    ...
    config: {
      departments: [
        { name: 'Underwriting', roles: ['Insurance Underwriter', 'Senior Underwriter'] },
        { name: 'Claims', roles: ['Claims Adjuster', 'Claims Processor'] },
        { name: 'Sales', roles: ['Insurance Agent', 'Broker'] },
        { name: 'Actuarial', roles: ['Actuary', 'Risk Analyst'] },
        { name: 'Administration', roles: ['Office Manager', 'Executive Assistant'] },
      ],
    },
  },
