...
> Last updated: 2026-07-05 19:50 PKT — Auth Hardening Batch 1a shipped (FIX-016: 10 auth bugs fixed, Contabo tenant build fixed)
...
| AD10 | `next.config.js` standalone output — breaks if moving to Vercel-style deployment | ⚠️ | frontend-admin.md §12 #5; future-plans §3.3 |
...
| PE3 | Vercel-vs-Contabo evaluation (currently Contabo only; re-eval quarterly) | 🔴 | future-plans §3.3 |
